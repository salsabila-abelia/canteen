...
export class ReviewService {
  ...
  async createReview(userId: number, orderId: number, rating: number, comment?: string) {
    ...
    const existingReview = await this.prisma.review.findUnique({ where: { order_id: orderId } });
    if (existingReview) {
